...
def test_when_query_is_exactly_at_least_one_of_the_alternative_city_names_score_one(starts_with_metric):
    ...
    assert 1.0 == get_score_from_alt_city_name_metric(starts_with_metric, alt_city_names, A_CITY_NAME)
...
def test_when_query_is_the_first_letter_of_the_city_name_score_one(starts_with_metric):
    assert 1.0 == get_score_from_city_name_metric(starts_with_metric, A_CITY_NAME, FIRST_LETTER_OF_A_CITY_NAME)
